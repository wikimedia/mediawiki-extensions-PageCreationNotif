...
$messages['dsb'] = array(
	...
	'page-creation-email-subject' => 'Nowy bok - $3 jo $1 na $2 {{GENDER:$3|napórał|napórała}}',
...
سامانهٔ اعلان {{SITENAME}} دوستانهٔ شما.
...
$messages['hsb'] = array(
	...
	'page-creation-email-subject' => 'Nowa strona - $3 je $1 na $2 {{GENDER:$3|wutworił|wutworiła}}',
	'page-creation-email-body' => 'Witaj $1,
 ...
 */
$messages['mr'] = array(
	'page-creation-email-subject' => 'नविन पान -$1, $3 ने $2 वर {{GENDER:$3|तयार केले}}',
	'page-creation-email-body' => 'प्रिय$1,

ही {{SITENAME}} या संकेतस्थळाहून सूचना आली आहे कि सदस्य $3 मार्फत एक नविन पान{{GENDER:$3|तयार करण्यात आले आहे}}.
...
आपली विपत्र सूचना मांडणी बदलवण्यासाठी {{canonicalurl:{{#special:पसंतीक्रम}}}} येथे भेट द्या.', # Fuzzy
);
...
$messages['ru'] = array(
	...
	'page-creation-email-body' => 'Уважаемый $1,

Это уведомление от {{SITENAME}} о том, что новая страница $2 создана {{GENDER:$3|участником|участницей|}} $3.
...
Ваша система уведомления {{SITENAME}}.

Для изменения настроек уведомления по электронной почте, зайдите на
{{canonicalurl:{{#special:Preferences}}}}',
);
...
$messages['zh-hans'] = array(
	...
	'page-creation-email-subject' => '新页面 - $1 由 $3 创建于 $2',
